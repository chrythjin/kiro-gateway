...
# Or with custom port (if 8888 is busy)
...
```bash
docker run -d -p 8888:8888 --env-file .env --name kiro-gateway ghcr.io/jwadow/kiro-gateway:latest
```
...
docker run -d -p 8888:8888 --env-file .env kiro-gateway
```
